            ...
            <main className='mainProject'>
                ...
                <div className='flex flex-center gap-5'>
                    ...
                    <div className='flex flex-center flex-col project-container ex-project-container  gap-40'>
                        <div className= 'mr-10 hover-lift flex flex-col gap-10 ex-box-container'>
                        ...
                        <div className='hover-lift flex flex-col gap-10 ex-box-container'>
                        ...
                        <div className='hover-lift flex flex-col gap-5 ex-box-container'>
